...
client.on('ready', function(){ // Leaked by [ @M3a4x ]
    var ms = 30000 ;
    var setGame = [`Dark Community `,` $help | $invites`];
    var i = -1;
    var j = 0;
...
var message = "zg";
         const embed = new Discord.RichEmbed()
     .setColor("GOLD")
     .setTitle('Hano Army Link Click Here .!')
     .setURL('https://discord.gg/hp8RNSY')
  .setDescription(`**
  New Server Add Hano Army ✅
...
client.on('message',async message => {
  ...
  if(args[0] === `${client.config.prefix}top`) {
    ...
    topRoyale.setFooter(`Dark Community`, message.guild.iconURL);
